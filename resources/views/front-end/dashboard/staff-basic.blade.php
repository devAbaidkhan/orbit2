      ...
      <h2 class="title text-center">What are you looking for?</h2>
        ...
        <div class="col-lg-3 col-md-4 col-6 text-center mb-3">
            <div class="ans-category-item pt-3">
                <a href="{{url('staff/create/religion')}}" class="category-item p-0">
        ...
        <div class="col-lg-3 col-md-4 col-6 text-center mb-3">
            <div class="ans-category-item pt-3">
                <a href="{{url('staff/create/bank')}}" class="category-item p-0">
        ...
        <div class="col-lg-3 col-md-4 col-6 text-center mb-3">
            <div class="ans-category-item pt-3">
                <a href="{{url('staff/create/passport')}}" class="category-item p-0">
                    <div class="category-icon mb-3">
