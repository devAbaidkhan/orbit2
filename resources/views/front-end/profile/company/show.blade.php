            ...
            <div class="col-lg-9" style="padding-bottom:70px;">
                    ...
                    <div class="employers-list-details">
                        <div class="employers-list-info">
                            <div class="employers-list-title">
                                <h5 class="mb-0 ob-company-heading"><a href="employer-detail.html">Electrician Officer</a><a href="staff-job-listing.php"><span class="job-listing-link">- 05 Application (view)</span></a></h5>
                            </div>
                            <div class="employers-list-option">
                                <ul class="list-unstyled">
                                    <li>Corporate</li>
                                    <li><i class="fas fa-map-marker-alt pe-1"></i>Monday to Friday 0800-1700. Officer should be smart, professional and</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div class="employers-list">
                    <div class="employers-list-details">
                        <div class="employers-list-info">
                            <div class="employers-list-title">
                                <h5 class="mb-0 ob-company-heading"><a href="employer-detail.html">Officer</a><a href="staff-job-listing.php"><span class="job-listing-link">- 05 Application (view)</span></a></h5>
                            </div>
                            <div class="employers-list-option">
                                <ul class="list-unstyled">
                                    <li>Corporate</li>
                ...
                <div class="employers-list">
                    <div class="employers-list-details">
                        <div class="employers-list-info">
                            <div class="employers-list-title">
                                <h5 class="mb-0 ob-company-heading"><a href="employer-detail.html">Protocol Officer</a><a href="staff-job-listing.php"><span class="job-listing-link">- 05 Application (view)</span></a></h5>
                            </div>
                            <div class="employers-list-option">
                                <ul class="list-unstyled">
                                    <li>Corporate</li>
